...
from fitness.pipeline import connect, ingest, refresh, erase_user
...
def main():
    ...
    summary=commands.add_parser('summarize');summary.add_argument('--as-of',required=True)
    ...
    with connect(args.database) as conn:
        ...
        elif args.command=='summarize':result=refresh(conn,args.as_of)
